...
void main() {
  group('UnsupportedMessage', () {
    ...
    test('initializes correctly from a JSON', () {
      ...
      expect(
        message.timestamp,
        DateTime.fromMillisecondsSinceEpoch(1621267200000),
      );
    ...
    test('creates a correct copy with new values through copyWith', () {
      final copiedMessage = message.copyWith(
        timestamp: DateTime.fromMillisecondsSinceEpoch(1621267200000 + 10000),
      ...
      expect(
        ...
        DateTime.fromMillisecondsSinceEpoch(1621267200000 + 10000),
      );
      expect(copiedMessage.type, 'unsupported');
